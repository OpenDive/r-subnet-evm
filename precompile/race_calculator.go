...
var (
	...
	getRaceScoreSignature = CalculateFunctionSelector("getRaceScore(uint256[] memory, uint256[] memory)")
...
func createNativeScorePrecompile(precompileAddr common.Address) StatefulPrecompiledContract {
	...
	getHighestScore := newStatefulPrecompileFunction(getRaceScoreSignature, getHighestScore)
